	...
	<main class="container">
		<section id="titulo">
			<div>
				<div class="row">
					<div class="col-md-12">
						<h2 class="fonte-titulo texto-cor-especial my-4">Categorias</h2>
						<a class="btn btn-secondary mb-4"
							href="${contextPath}/categoria/form?page=categoria-nova">Nova Categoria</a>
				...
				<tbody>
					<c:forEach items="${categorias}" var="categoria">
						<tr>
							...
							<td>
								<form:form action="${contextPath}/categoria/${categoria.idCategoria}" 
									method="delete">
									<a href="${contextPath}/categoria/${categoria.idCategoria}"
										class="btn btn-success btn-sm">Detalhes</a> <a
										href="${contextPath}/categoria/form?page=categoria-editar&id=${categoria.idCategoria}"
