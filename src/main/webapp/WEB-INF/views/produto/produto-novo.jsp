						...
						<div class="well">
							...
							<form:form modelAttribute="produtoModel"
								...
								<div class="form-group">
									...
									<form:input path="nome" type="text" name="nome" id="nome"
										value="" class="form-control" maxlength="50" size="50" />
									<font color="red"> <form:errors path="nome" />
									</font>
								</div>
								<div class="form-group">
									<label class="control-label" for="categoria">Categoria:</label>
									<form:select path="categoriaModel.idCategoria"
										class="form-select" name="categoriaModel.idCategoria"
										id="idCategoria">
								...
								<div class="form-group">
									...
									<form:input path="sku" type="text" name="sku" id="sku"
								...
								<div class="form-group">
									...
									<font color="red"> <form:errors path="descricao" />
									</font>
								</div>

								<div class="form-group">
									<label class="control-label" for="preco">Preço:</label>
									<form:input path="preco" type="number" id="preco" name="preco"
										step=".01" class="form-control" />
									<font color="red"> <form:errors path="preco" />
									</font>
								</div>

								<div class="form-group">
									<label class="control-label" for="caracteristica">Características:</label>
									<form:textarea path="caracteristicas" id="caracteristicas"
										class="form-control" name="caracteristicas" rows="4"
										cols="100"></form:textarea>
									<font color="red"> <form:errors path="caracteristicas" />
									</font>
								</div>
								<hr>
